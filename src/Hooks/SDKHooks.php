...
class SDKHooks implements Hooks
{
    ...
    /**
     * @var ClientCredentialsHook $clientCredentialsHook
     */
    private ClientCredentialsHook $clientCredentialsHook;

    public function __construct()
    {
        $this->clientCredentialsHook = new ClientCredentialsHook();
        $this->sdkInitHooks[] = $this->clientCredentialsHook;
        $this->beforeRequestHooks[] = $this->clientCredentialsHook;
        $this->afterErrorHooks[] = $this->clientCredentialsHook;
