...
class SDKV2
{
     ...
     */
    public function cancelEvent(Operations\V2CancelEventRequest $request): Operations\V2CancelEventResponse
    {
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function createTrigger(?Shared\V2TriggerData $request = null): Operations\V2CreateTriggerResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function createWorkflow(?Shared\V2CreateWorkflowRequest $request = null): Operations\V2CreateWorkflowResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function deleteTrigger(Operations\V2DeleteTriggerRequest $request): Operations\V2DeleteTriggerResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function deleteWorkflow(Operations\V2DeleteWorkflowRequest $request): Operations\V2DeleteWorkflowResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function getInstance(Operations\V2GetInstanceRequest $request): Operations\V2GetInstanceResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function getInstanceHistory(Operations\V2GetInstanceHistoryRequest $request): Operations\V2GetInstanceHistoryResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function getInstanceStageHistory(Operations\V2GetInstanceStageHistoryRequest $request): Operations\V2GetInstanceStageHistoryResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function getServerInfo(): Operations\V2GetServerInfoResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function getWorkflow(Operations\V2GetWorkflowRequest $request): Operations\V2GetWorkflowResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function listInstances(?Operations\V2ListInstancesRequest $request = null): Operations\V2ListInstancesResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function listTriggers(?Operations\V2ListTriggersRequest $request = null): Operations\V2ListTriggersResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        $url = Utils\Utils::generateUrl($baseUrl, '/api/orchestration/v2/triggers');
        $urlOverride = null;
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function listTriggersOccurrences(Operations\V2ListTriggersOccurrencesRequest $request): Operations\V2ListTriggersOccurrencesResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function listWorkflows(?Operations\V2ListWorkflowsRequest $request = null): Operations\V2ListWorkflowsResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
        $url = Utils\Utils::generateUrl($baseUrl, '/api/orchestration/v2/workflows');
        $urlOverride = null;
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function readTrigger(Operations\V2ReadTriggerRequest $request): Operations\V2ReadTriggerResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function runWorkflow(Operations\V2RunWorkflowRequest $request): Operations\V2RunWorkflowResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function sendEvent(Operations\V2SendEventRequest $request): Operations\V2SendEventResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
     ...
     * @throws \formance\stack\Models\Errors\SDKException
     */
    public function testTrigger(Operations\TestTriggerRequest $request): Operations\TestTriggerResponse
    {
        $baseUrl = Utils\Utils::templateUrl($this->sdkConfiguration->getServerUrl(), $this->sdkConfiguration->getServerDefaults());
