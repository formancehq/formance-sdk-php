...
class AlertsCursorResponseCursor
{
    /**
     * $data
     *
     * @var array<\formance\stack\Models\Reconciliation\Alert> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Reconciliation\Alert>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Reconciliation\Alert>  $data
     * @param  bool  $hasMore
     * @param  int  $pageSize
     * @param  ?string  $next
