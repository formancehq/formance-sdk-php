...
class RulesCursorResponseCursor
{
    /**
     * $data
     *
     * @var array<\formance\stack\Models\Reconciliation\Rule> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Reconciliation\Rule>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Reconciliation\Rule>  $data
     * @param  bool  $hasMore
     * @param  int  $pageSize
     * @param  ?string  $next
