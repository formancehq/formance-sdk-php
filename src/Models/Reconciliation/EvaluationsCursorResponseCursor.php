...
class EvaluationsCursorResponseCursor
{
    /**
     * $data
     *
     * @var array<\formance\stack\Models\Reconciliation\Evaluation> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Reconciliation\Evaluation>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Reconciliation\Evaluation>  $data
     * @param  bool  $hasMore
     * @param  int  $pageSize
     * @param  ?string  $next
