...
class TaskStripe
{
    ...
    /**
     *
     * @var \formance\stack\Models\Payments\TaskStripeDescriptor $descriptor
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('descriptor')]
    #[\Speakeasy\Serializer\Annotation\Type('\formance\stack\Models\Payments\TaskStripeDescriptor')]
    ...
    #[\Speakeasy\Serializer\Annotation\Type('\formance\stack\Models\Payments\TaskStripeState|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  \formance\stack\Models\Payments\TaskStripeDescriptor  $descriptor
     * @param  string  $id
     * @param  \formance\stack\Models\Payments\TaskStatus  $status
     * @param  \DateTime  $updatedAt
     * @param  ?string  $error
     * @param  ?\formance\stack\Models\Payments\TaskStripeState  $state
     * @phpstan-pure
     */
