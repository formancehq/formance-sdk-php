...
class BankAccountsCursorCursor
{
     ...
     * $data
     *
     * @var array<\formance\stack\Models\Payments\BankAccount> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Payments\BankAccount>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Payments\BankAccount>  $data
     * @param  bool  $hasMore
     * @param  int  $pageSize
     * @param  ?string  $next
