...
class V3CoinbaseprimeConfig
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $apiKey, string $apiSecret, string $name, string $passphrase, string $portfolioId, ?int $pageSize = 25, ?string $pollingPeriod = '30m', ?string $provider = 'Coinbaseprime')
    {
        $this->apiKey = $apiKey;
