...
class V3KrakenproConfig
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $apiKey, string $apiSecret, string $endpoint, string $name, ?int $pageSize = 25, ?string $pollingPeriod = '30m', ?string $provider = 'Krakenpro')
    {
        $this->apiKey = $apiKey;
