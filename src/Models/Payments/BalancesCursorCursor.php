...
class BalancesCursorCursor
{
     ...
     * $data
     *
     * @var array<\formance\stack\Models\Payments\AccountBalance> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Payments\AccountBalance>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Payments\AccountBalance>  $data
     * @param  bool  $hasMore
     * @param  int  $pageSize
     * @param  ?string  $next
