...
class V3ModulrConfig
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $apiKey, string $apiSecret, string $endpoint, string $name, ?int $pageSize = 25, ?string $pollingPeriod = '30m', ?string $provider = 'Modulr')
    {
        $this->apiKey = $apiKey;
