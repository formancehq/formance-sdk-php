...
class PaymentsCursorCursor
{
     ...
     * $data
     *
     * @var array<\formance\stack\Models\Payments\Payment> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Payments\Payment>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Payments\Payment>  $data
     * @param  bool  $hasMore
     * @param  int  $pageSize
     * @param  ?string  $next
