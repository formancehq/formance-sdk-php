...
class Hold1
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $asset, string $description, string $id, array $metadata, \Brick\Math\BigInteger $originalAmount, \Brick\Math\BigInteger $remaining, string $walletID, LedgerAccountSubject|WalletSubject|null $subject = null)
    {
        $this->asset = $asset;
