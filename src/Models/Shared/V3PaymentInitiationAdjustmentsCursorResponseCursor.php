...
class V3PaymentInitiationAdjustmentsCursorResponseCursor
{
    /**
     * $data
     *
    ...
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Shared\V3PaymentInitiationAdjustment>')]
    public array $data;
