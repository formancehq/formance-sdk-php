...
class ActivityStripeTransfer
{
    ...
    #[\JMS\Serializer\Annotation\Type('\formance\stack\Models\Shared\Metadata')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     */
    public function __construct(?int $amount = null, ?string $asset = null, ?string $connectorID = null, ?string $destination = null, ?Metadata $metadata = null, ?bool $waitingValidation = null)
    {
        $this->amount = $amount;
        $this->asset = $asset;
