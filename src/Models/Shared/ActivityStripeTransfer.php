...
class ActivityStripeTransfer
{
    ...
    #[\Speakeasy\Serializer\Annotation\Type('\formance\stack\Models\Shared\Metadata|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     */
    public function __construct(?\Brick\Math\BigInteger $amount = null, ?string $asset = null, ?string $connectorID = null, ?string $destination = null, ?Metadata $metadata = null, ?bool $waitingValidation = false)
    {
        $this->amount = $amount;
        $this->asset = $asset;
