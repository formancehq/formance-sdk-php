...
class Hold
{
     ...
     */
    public function __construct(?string $description = null, ?string $id = null, ?array $metadata = null, ?string $walletID = null, LedgerAccountSubject|WalletSubject|null $destination = null)
    {
