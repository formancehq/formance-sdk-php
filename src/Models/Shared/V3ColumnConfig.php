...
class V3ColumnConfig
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $apiKey, string $endpoint, string $name, ?int $pageSize = 25, ?string $pollingPeriod = '30m', ?string $provider = 'Column')
    {
        $this->apiKey = $apiKey;
