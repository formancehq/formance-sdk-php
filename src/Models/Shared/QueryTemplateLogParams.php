...
class QueryTemplateLogParams
{
    ...
    #[\Speakeasy\Serializer\Annotation\Type('\formance\stack\Models\Shared\V2QueryParamsSchemasTrueResource|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(?string $cursor = null, ?string $expand = null, ?int $pageSize = null, ?\DateTime $pit = null, ?V2QueryParamsSchemasTrueResource $resource = null, ?string $sort = null)
    {
        $this->cursor = $cursor;
        $this->expand = $expand;
