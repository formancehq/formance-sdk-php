...
class V2ListWalletsResponseCursor
{
     ...
     * $data
     *
     * @var array<\formance\stack\Models\Orchestration\V2Wallet> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\formance\stack\Models\Orchestration\V2Wallet>')]
    public array $data;
    ...
    /**
     * @param  array<\formance\stack\Models\Orchestration\V2Wallet>  $data
     * @param  int  $pageSize
     * @param  ?bool  $hasMore
     * @param  ?string  $next
