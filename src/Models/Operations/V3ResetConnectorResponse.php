...
class V3ResetConnectorResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, ResponseInterface $rawResponse, ?\formance\stack\Models\Payments\V3ResetConnectorResponse $v3ResetConnectorResponse = null)
    {
