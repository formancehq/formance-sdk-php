...
class V2GetLedgerInfoResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\V2LedgerInfoResponse $v2LedgerInfoResponse = null)
    {
