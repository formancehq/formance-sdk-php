...
class TestConfigResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\AttemptResponse $attemptResponse = null)
    {
