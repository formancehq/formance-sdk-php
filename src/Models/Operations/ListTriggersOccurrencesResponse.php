...
class ListTriggersOccurrencesResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, ResponseInterface $rawResponse, ?\formance\stack\Models\Orchestration\ListTriggersOccurrencesResponse $listTriggersOccurrencesResponse = null)
    {
