...
class V3ForwardPaymentServiceUserBankAccountResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, ResponseInterface $rawResponse, ?\formance\stack\Models\Payments\V3ForwardPaymentServiceUserBankAccountResponse $v3ForwardPaymentServiceUserBankAccountResponse = null)
    {
