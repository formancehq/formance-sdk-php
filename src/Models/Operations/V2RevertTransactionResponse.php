...
use formance\stack\Models\Ledger\V2CreateTransactionResponse;
...
class V2RevertTransactionResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, ResponseInterface $rawResponse, ?V2CreateTransactionResponse $v2CreateTransactionResponse = null, ?array $headers = [])
    {
