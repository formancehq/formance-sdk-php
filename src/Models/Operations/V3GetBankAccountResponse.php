...
class V3GetBankAccountResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, ResponseInterface $rawResponse, ?\formance\stack\Models\Payments\V3GetBankAccountResponse $v3GetBankAccountResponse = null)
    {
