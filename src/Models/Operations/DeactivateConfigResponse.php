...
class DeactivateConfigResponse
{
     ...
     */
    public function __construct(?string $contentType = null, ?int $statusCode = null, ?\Psr\Http\Message\ResponseInterface $rawResponse = null, ?Shared\ConfigResponse $configResponse = null)
    {
