...
class ListBalancesResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, ResponseInterface $rawResponse, ?\formance\stack\Models\Wallets\ListBalancesResponse $listBalancesResponse = null)
    {
