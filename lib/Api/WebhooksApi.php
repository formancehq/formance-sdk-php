...
/**
     ...
     * @return \Formance\Model\ConfigActivatedResponse
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\ConfigActivatedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function activateOneConfigWithHttpInfo($id, string $contentType = self::contentTypes['activateOneConfig'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Formance\Model\ConfigActivatedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\ConfigActivatedResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\ConfigActivatedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Formance\Model\ConfigActivatedResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\ConfigActivatedResponse',
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\ConfigDeactivatedResponse
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\ConfigDeactivatedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deactivateOneConfigWithHttpInfo($id, string $contentType = self::contentTypes['deactivateOneConfig'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Formance\Model\ConfigDeactivatedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\ConfigDeactivatedResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\ConfigDeactivatedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Formance\Model\ConfigDeactivatedResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\ConfigDeactivatedResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\ConfigActivatedResponse|string
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\ConfigActivatedResponse|string, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation testOneConfig
     *
     * Test one config
     *
     * @param  string $id Config ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['testOneConfig'] to see the possible values for this operation
     *
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\AttemptResponse
     */
    public function testOneConfig($id, string $contentType = self::contentTypes['testOneConfig'][0])
    {
        list($response) = $this->testOneConfigWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation testOneConfigWithHttpInfo
     *
     * Test one config
     *
     * @param  string $id Config ID (required)
     ...
     */
    public function testOneConfigWithHttpInfo($id, string $contentType = self::contentTypes['testOneConfig'][0])
    {
        $request = $this->testOneConfigRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testOneConfigAsync($id, string $contentType = self::contentTypes['testOneConfig'][0])
    {
        return $this->testOneConfigAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testOneConfigAsyncWithHttpInfo
     *
     * Test one config
     *
     * @param  string $id Config ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testOneConfigAsyncWithHttpInfo($id, string $contentType = self::contentTypes['testOneConfig'][0])
    {
        $returnType = '\Formance\Model\AttemptResponse';
        $request = $this->testOneConfigRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'testOneConfig'
     *
     * @param  string $id Config ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['testOneConfig'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testOneConfigRequest($id, string $contentType = self::contentTypes['testOneConfig'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling testOneConfig'
            );
        }
