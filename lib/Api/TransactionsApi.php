...
/**
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\GetTransaction400Response',
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\GetTransaction404Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\AddMetadataToAccount409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $ledger Name of the ledger. (required)
     * @param  \Formance\Model\TransactionData $transaction_data transaction_data (required)
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\TransactionsResponse|\Formance\Model\TransactionsResponse|\Formance\Model\CreateTransaction400Response|\Formance\Model\CreateTransaction409Response
     */
     ...
     *
     * @param  string $ledger Name of the ledger. (required)
     * @param  \Formance\Model\TransactionData $transaction_data (required)
     * @param  bool $preview Set the preview mode. Preview mode doesn&#39;t add the logs to the database or publish a message to the message broker. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createTransaction'] to see the possible values for this operation
     *
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\TransactionsResponse|\Formance\Model\TransactionsResponse|\Formance\Model\CreateTransaction400Response|\Formance\Model\CreateTransaction409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTransactionWithHttpInfo($ledger, $transaction_data, $preview = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Formance\Model\CreateTransaction400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\CreateTransaction400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\CreateTransaction400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\Formance\Model\CreateTransaction409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\CreateTransaction409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\CreateTransaction409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\CreateTransaction400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\CreateTransaction409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createTransactionRequest($ledger, $transaction_data, $preview = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        ...
        if (isset($transaction_data)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($transaction_data));
            } else {
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\TransactionsResponse|\Formance\Model\CreateTransactions400Response|\Formance\Model\CreateTransaction409Response
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\TransactionsResponse|\Formance\Model\CreateTransactions400Response|\Formance\Model\CreateTransaction409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTransactionsWithHttpInfo($ledger, $transactions, string $contentType = self::contentTypes['createTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Formance\Model\CreateTransactions400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\CreateTransactions400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\CreateTransactions400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\CreateTransactions400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\TransactionResponse|\Formance\Model\GetTransaction400Response|\Formance\Model\GetTransaction404Response
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\TransactionResponse|\Formance\Model\GetTransaction400Response|\Formance\Model\GetTransaction404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionWithHttpInfo($ledger, $txid, string $contentType = self::contentTypes['getTransaction'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Formance\Model\GetTransaction400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\GetTransaction400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\GetTransaction400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
                    if ('\Formance\Model\GetTransaction404Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\GetTransaction404Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\GetTransaction404Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\ListTransactions200Response|\Formance\Model\ListAccounts400Response
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\ListTransactions200Response|\Formance\Model\ListAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function listTransactionsWithHttpInfo($ledger, $page_size = 15, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $end_time = null, $pagination_token = null, $metadata = null, string $contentType = self::contentTypes['listTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Formance\Model\ListTransactions200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\ListTransactions200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\ListTransactions200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Formance\Model\ListTransactions200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\ListTransactions200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Formance\Model\TransactionResponse|\Formance\Model\GetTransaction400Response|\Formance\Model\GetTransaction404Response|\Formance\Model\AddMetadataToAccount409Response
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\TransactionResponse|\Formance\Model\GetTransaction400Response|\Formance\Model\GetTransaction404Response|\Formance\Model\AddMetadataToAccount409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function revertTransactionWithHttpInfo($ledger, $txid, string $contentType = self::contentTypes['revertTransaction'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 409:
                    if ('\Formance\Model\AddMetadataToAccount409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\AddMetadataToAccount409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\AddMetadataToAccount409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
