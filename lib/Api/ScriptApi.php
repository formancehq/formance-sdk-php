...
/**
     ...
     * @return \Formance\Model\ScriptResult|\Formance\Model\RunScript400Response|\Formance\Model\AddMetadataToAccount409Response
     */
     ...
     * @throws \Formance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Formance\Model\ScriptResult|\Formance\Model\RunScript400Response|\Formance\Model\AddMetadataToAccount409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function runScriptWithHttpInfo($ledger, $script, $preview = null, string $contentType = self::contentTypes['runScript'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Formance\Model\RunScript400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Formance\Model\RunScript400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Formance\Model\RunScript400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Formance\Model\RunScript400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
