...
| `targetId`                                                       | [string\|\Brick\Math\BigInteger](../../Models/ledger/TargetId.md) | :heavy_check_mark:                                               | N/A                                                              |
| `targetType`                                                     | [Ledger\TargetType](../../Models/ledger/TargetType.md)           | :heavy_check_mark:                                               | Type of the target entity                                        |